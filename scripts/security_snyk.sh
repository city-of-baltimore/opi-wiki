...
# only. Confirm any recurring server-side integration in Snyk itself before
# relying on it. See patapsco/docs/operations/snyk-scanning.md.
#
...
# can report versions that do not match uv.lock. This script therefore provides
# source-code analysis only; it does not establish Python dependency coverage.
