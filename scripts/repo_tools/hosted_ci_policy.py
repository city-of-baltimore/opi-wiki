...
the shared checker had no equivalent rule. 0.6.17 and later report any ``uses:``
that is not a SHA-pinned trusted action as an opaque action, so the case no longer
