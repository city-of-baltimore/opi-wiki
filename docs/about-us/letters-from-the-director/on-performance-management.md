...
That is the gap performance management is supposed to close. Not the dashboard. Not the report. The routine: the recurring management conversation in which leaders look at how a service is performing, ask honest questions about why, decide what to do, and come back next month to check whether the action worked. When that routine is real, government gets better. When it is not, performance becomes performance art.

Baltimore has a long history with this work. CitiStat was built here in the early 2000s and became a model that cities around the country tried to copy. The original premise was right: bring leaders into a room, look at the data together, expect follow-through. The premise is still right. What has to evolve is the practice.

## What performance management actually is

Performance management is the discipline of using evidence to manage public services. It has four parts that have to work together. Measures that reflect what residents experience and what staff actually do. Routines that bring the right people together to look at those measures on a regular schedule. Decisions that get documented, with owners and due dates. And follow-through that closes the loop: next session, did the action happen, and did it move the measure?

Take any one of those parts away and the system stops working. Measures without routines become reports nobody opens. Routines without measures become meetings about feelings. Decisions without documentation evaporate by the time the room clears. Documentation without follow-through teaches everyone that the routine does not really matter. The whole loop has to be intact.
...
That is the routine. It is unglamorous on purpose. Performance management does not need to be theatrical to be powerful. It needs to be reliable.
...
Residents do not see CitiStat. They should not have to. What they see, if performance management is working, is that 311 closes service requests faster, that permit reviews stop disappearing into a queue, that crews show up when they say they will, that the second visit happens, that complaints get a clear answer, and that when something is not working, City Hall is honest about it.

That is the test. Performance management is not the room where leaders gather. Performance management is whether residents experience a city that is paying attention to its own services and adjusting when they fall short.

## What we ask of agencies
