...
Data can help us deliver that. Not by replacing people, but by supporting them. Not by making every decision automatic, but by making decisions more informed. Not by hiding complexity, but by helping leaders and staff see complexity clearly enough to act.

The standard is simple: when Baltimore makes decisions, those decisions should be grounded in the best possible information, governed responsibly, explained clearly, and used in service of residents.

That is the promise of trustworthy data. That is the foundation for responsible AI. And that is the kind of government we are building in Baltimore.
...
**Data & Analytics Strategy FY27 —** *how Baltimore is building citywide data infrastructure.*

**Data Governance Framework FY27 —** *roles, standards, and decision rights for data stewardship.*
