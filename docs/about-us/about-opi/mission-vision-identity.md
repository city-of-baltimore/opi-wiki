...
| **Value** | **What it means**                                                                |
|-----------|----------------------------------------------------------------------------------|
| GRIT      | We persist through complexity, bureaucracy, and setbacks to deliver results.     |
| CANDOR    | We say the true thing kindly and early. Surface risks before they become crises. |
| OWNERSHIP | If we see a problem, we help solve it. We follow through to closure.             |
| HUMILITY  | We listen, learn, and share credit. We build trust with partners.                |
| INTENTION | We move fast when needed, but always with clarity, purpose, and discipline.      |
| IMPACT    | We build solutions that last — owned by agencies and sustained over time.        |
...
- Data products: shared datasets, dashboards, open data publications, methodology cards, AI evaluation memos.

- Service products: redesigned workflows, prototypes, MVPs, performance management portals, data collection tools.

- Delivery artifacts: project charters, implementation plans, SOPs, training materials.
...
- Translators between residents, agencies, leadership, and technology.

- Disciplined operators who finish things and document them.
...
- The agency that does the agency’s job. We help agencies own and sustain change, not take their work over.
...
|----------------------|-----------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| Mayor and CA         | Decisions, narratives, follow-through.                          | Stat portfolio, executive briefings, public summaries, delivery activations.                |
| Deputy Mayors / DCAs | Portfolio oversight, escalation paths, cross-agency authority.  | Stat sessions as Authorizer, delivery sponsorship, monthly impact briefs.                   |
| Agencies             | Method, coaching, shared infrastructure.                        | Performance plans, KPI Dictionary, data products, service redesigns, SOPs.                  |
| City Council         | Transparent reporting, district-level views, oversight support. | Public narrative templates, district dashboards, annual report sections.                    |
