...
- External products meet Section 508 accessibility standards (see [Data standards and evidence](citistat-method-playbook.md#data-standards-and-evidence) in the Method Playbook).
...
- [CitiStat Method Playbook](citistat-method-playbook.md) — the operating standards these quality bars enforce.
- [CitiStat Templates](citistat-templates.md) — the artifacts these standards apply to.
- [CitiStat — Staff Quick Reference](citistat-method-staff-quick-reference.md) — the at-a-glance method companion.
- [CitiStat Method Playbook → Data standards and evidence](citistat-method-playbook.md#data-standards-and-evidence) — the data discipline that feeds these checklists.
- [CitiStat Method Playbook → Follow-up, escalation, and sustainment](citistat-method-playbook.md#follow-up-escalation-and-sustainment) — what the follow-up checklist supports.
