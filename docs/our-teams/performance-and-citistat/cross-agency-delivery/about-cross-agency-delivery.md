...
Cross-Agency Delivery is led by the Performance Management portfolio, with the Innovation Lab as the design and product partner. The service runs in four modes:

- Tiger Teams — short, time-boxed sprints that pull staff from multiple agencies into one shared workplan with a single decision lead.

- Embedded Delivery — OPI staff sit inside an agency for 90 to 180 days to stand up a routine, train the team, and hand it back.

- Joint Stats — thematic Stats that put two or more agencies in front of the City Administrator on the same problem at the same time.

- Council and Mayor priorities — OPI staff work directly with the Mayor’s Office, the City Administrator, and Council on cross-agency commitments that need disciplined follow-through.
...
| Run       | Stand up the squad, the routine, and the data. Run a weekly or bi-weekly cycle for 60–120 days.    | OPI delivery lead embedded with the agencies           |
...
- OPI About Performance Management

- OPI ToC Cross Agency Delivery (Theory of Change)

- OPI Tiger Teams Playbook

- OPI CitiStat Method Playbook
