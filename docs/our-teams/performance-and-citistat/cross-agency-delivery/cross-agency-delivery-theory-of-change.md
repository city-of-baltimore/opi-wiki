...
- Tiger teams over standing committees. Time-boxed, outcome-owned, with a named sponsor and an exit criteria.
...
- A priority outcome with a named Executive Sponsor / Authorizer.
...
| **Topic**                        | **Summary**                                                                                                                                                                                                                                |
|----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| What it is                       | A service overlay that activates when a problem requires sequencing across agencies, named decision rights, and weekly delivery discipline. Tiger teams, delivery rooms, and cross-agency workplans are the core mechanisms.               |
...
| Service overlay, not a portfolio | Cross-Agency Delivery is staffed and operated through the four portfolios. Danny Heller (Deputy Chief Performance Officer) serves as Interim Delivery Manager. Rakeim Young (Chief of Staff) provides portfolio visibility and escalation. |
...
We do not run delivery rooms for everything. The overlay activates only when the problem meets all six criteria. If it does not, we use a different routine — a Stat, a product council, a charter and an owner, or a one-time decision memo.
...
- A specific Authorizer (Mayor, CA, Deputy Mayor, or DCA) has confirmed sponsorship and decision rights.

- A named Senior Responsible Owner is willing to lead implementation.
...
| Deliver             | Run weekly delivery rooms with the SRO and agency owners; track commitments; escalate blockers to the Authorizer; QA before any public release. | Weekly status; commitment ledger; decision log; QA sign-offs; blocker escalations. |
...
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs             | Authorizer with real decision rights; named SRO; agency owners with commitments; data feeds from the Data and Analytics service; partnership and procurement support; Communications and Narrative support; legal and HR partnerships when needed.                   |
| Activities         | Activate delivery rooms; map cross-agency workflows; track risks and dependencies; coordinate agency commitments; support executive escalation; document decisions and follow-up actions; help agencies sustain improvements through SOPs, training, and monitoring. |
| Outputs            | Cross-agency charters and workplans; weekly commitment ledgers; blocker escalation memos; decision logs; runbooks; SOP packages; closure memos.                                                                                                                      |
| Outcomes (0–6 mo)  | Activations have weekly cadence and named owners; commitments close on time; barriers reach Authorizers within five business days; agencies see decisions move.                                                                                                      |
...
| Delivery Lead (per activation) | Runs the delivery room, maintains the workplan, tracks commitments, and packages escalations for the Authorizer.                     |
| Chief of Staff (OPI)           | Provides portfolio visibility and ensures activations are coordinated with other OPI work.                                           |
| Agency Owners                  | Hold agency commitments; bring evidence to delivery rooms; sustain after closure.                                                    |

**6. Core offerings and target service levels**

| **Offering**           | **Typical customer**    | **When to use**                                                       | **Target SLA / cadence**                                                    |
|------------------------|-------------------------|-----------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Tiger Team activation  | Authorizer + SRO        | Time-boxed diagnosis and prototype on a priority cross-agency problem | 6–12 week sprint; charter within 10 business days.                          |
| Standing delivery room | Authorizer + SRO        | Cross-agency commitment that needs weekly cadence for 90+ days        | Weekly cadence; commitment ledger maintained continuously.                  |
...
- Cadence reliability — weekly delivery rooms held; commitment closure rate; blocker escalation lead time.
...
- From Data and Analytics → shared data models and instrumentation for activations.
...
- Cross-agency charter (scope, milestones, deliverables, owners by agency, decision points, definition of done, sustainment owner).

- Workflow / dependency map.

- Commitment ledger (open, closed, overdue, escalated).

- Decision log.

- Blocker escalation memo (to Authorizer).

- Closure memo (evidence of completion, sustainment plan, owner sign-off).

- Annual review checkpoint (12 months post-closure).
