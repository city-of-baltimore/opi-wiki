...
Use when a Stat is being established or reset. Length is typically 45 minutes.

| **Time**     | **Topic**                                                                                                                                                      |
|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 minutes    | Introductions and working purpose. Confirm who is in the room and the proposed working purpose of the Stat.                                                    |
| 15 minutes   | Initial Stat agenda walkthrough. Review the standing topics: opening, four tenets, purpose, follow-ups, KPI chart, operational metrics, agenda topics, and repeat-back. |
| 10 minutes   | Starting points. Confirm strategic goals, key work underway, the initial KPI set, and data sources.                                                            |
| 10 minutes   | Cadence and roles. Confirm Stat cadence, the Data-Driven Officer, the OPI lead, and the cabinet partners likely to be invited.                                 |
| 5 minutes    | Next steps. Confirm pre-memo timing, frame review, and the date of the first Stat.                                                                             |

### Frame review agenda

Use 5 to 8 days before each Stat. Length is typically 45 minutes.
...
| 3 minutes    | Action steps and owners.                                                                                                                                                                        |
...
|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2 minutes    | Welcome and introductions.                                                                                                                                         |
| 10 minutes   | Stat reflection. What worked, what could be different, and feedback received from attendees.                                                                       |
| 5 minutes    | Strategy for the next Stat. Draft preliminary agenda items emerging from the discussion; identify potential inspections or ride-alongs.                            |
| 10 minutes   | Review drafted follow-ups. Walk the drafted follow-up table for additions, removals, or edits before the follow-up memo is sent.                                   |
| 3 minutes    | Action steps before the follow-up memo is issued.                                                                                                                  |

## Materials send-out standard

Pre-meeting materials are distributed at least 48 hours before the Stat (T-2 in the [12-step analyst cycle](citistat-method-playbook.md#analyst-execution-cycle-the-12-steps)). The standard send-out includes the prior follow-up memo, the pre-memo, and the deck with questions, posted to the Stat's SharePoint location and distributed by email to the standing distribution list.
...
- Use a dash with spaces between segments.

| **Artifact**             | **Pattern**                                       | **Example**                            |
|--------------------------|---------------------------------------------------|----------------------------------------|
| Stat deck                | `<Agency> Stat - Deck - YYYY-MM-DD`               | `DGS Stat - Deck - 2025-10-29`         |
| Pre-memo                 | `<Agency> Stat - Pre-Memo - YYYY-MM-DD`           | `DGS Stat - Pre-Memo - 2025-10-29`     |
| Follow-up memo           | `<Agency> Stat - Follow-Up Memo - YYYY-MM-DD`     | `DGS Stat - Follow-Up Memo - 2025-10-29` |
| Frame review agenda      | `<Agency> Stat - Frame Review Agenda - YYYY-MM-DD`| `DGS Stat - Frame Review Agenda - 2025-10-22` |
| Debrief agenda           | `<Agency> Stat - Debrief Agenda - YYYY-MM-DD`     | `DGS Stat - Debrief Agenda - 2025-10-30` |
| Weekly status report     | `<Agency> Stat - Weekly Status - YYYY-MM-DD`      | `DGS Stat - Weekly Status - 2025-10-22` |

### Print order

Printed packets for the room follow a standard top-to-bottom order so panelists can flip through them consistently:

1. Last cycle's follow-up memo.
2. Pre-memo for the current Stat.
3. Deck with questions.

## Room setup and breakdown

Room setup is step 10 of the [12-step analyst execution cycle](citistat-method-playbook.md#analyst-execution-cycle-the-12-steps). The goal is a clean, organized, and fully functional space that supports both in-person panelists and remote attendees. The same checklist is run before every Stat and reversed after.
...
|--------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| E-mail Update            | A short, time-bounded update that closes with an emailed answer; no document or meeting is required.                                       |
| Memo                     | A short written analysis or recommendation on an issue raised in the Stat; the deliverable is the memo itself.                             |
...
Templates should create consistency without creating bureaucracy. Use them to make the work easier to prepare, easier to review, and easier to sustain. The templates below are for the artifacts produced inside a Stat — the pre-memo, the deck, the follow-up memo, the commitment tracker, and the weekly radar. Every artifact below pairs with a checklist on the [CitiStat Quality Standards](citistat-quality-standards.md) page.
...
- [CitiStat Method Playbook](citistat-method-playbook.md) — the operating standards these templates support.
- [CitiStat Quality Standards](citistat-quality-standards.md) — the QA bar every template output must meet.
- [CitiStat — Staff Quick Reference](citistat-method-staff-quick-reference.md) — the at-a-glance method companion.
