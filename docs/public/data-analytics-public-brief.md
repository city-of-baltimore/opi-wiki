...
The service is built on three commitments: trustworthy data, useful data products, and responsible use of analytics and AI. It works alongside CitiStat (which uses data to drive decisions) and the Innovation Lab (which uses data to redesign services).
...
- Public datasets across agencies, regularly updated.

- Documentation and metadata so datasets are usable, not just available.

- Privacy and sensitivity review to protect residents while maximizing public release.
...
- Performance dashboards that extend the value of CitiStat between sessions.

- Operational dashboards in active use by partner agencies (for example, a late-payments dashboard used by DGS).
...
- Plain-language standards for how City agencies should and should not use AI in service delivery.

- Inventory of analytics and AI uses already in flight across the City.

- Risk and equity review for new AI uses, anchored in the City’s public values.
...
- Agencies are accountable for the quality, timeliness, and openness of the data they hold; OPI provides standards, tools, and support.

- New analytics or AI projects should be reviewed before procurement, not after.

**If you are a researcher, journalist, or civic technologist**

- Start with Open Baltimore (data.baltimorecity.gov) for already-published datasets.

- For datasets not yet published, submit a request through the Open Data Program contact channel; the Chief Data Officer’s team will route it.
...
| **Authorities** | Baltimore City Code, Article 1, Subtitle 9 — Open Data Program |
...
| **Web**         | opi.baltimorecity.gov/data-and-analytics                       |

*Owned by Citywide Data and Analytics. Reviewed quarterly. Plain-language brief intended for public use.*
