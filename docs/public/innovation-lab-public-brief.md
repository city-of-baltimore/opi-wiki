...
**Design.** Reframe the problem. Co-design plain, practical changes — to forms, scripts, handoffs, queues, dashboards, or digital tools.

**Test.** Run small, time-boxed pilots. Measure before and after. Keep what works, drop what does not.
...
- Not an outside contractor. The Lab is a City team using City staff and capacity.
...
- 311 — reimagining intake, handoffs, work orders, and resident communications.

- Permitting — simplifying the Accela experience and clarifying who does what across agencies.

- Workday — making HR, finance, and capital workflows actually work for City staff.

- Cleanliness and right-of-way — sharper routing, faster follow-up, clearer accountability.
...
- Parking enforcement — redesigned end-to-end workflows with DOT and BCIT.

- Traffic calming requests — streamlined how requests are processed and communicated.
...
- **Co-own the work:** We expect agency staff time, leadership air cover, and willingness to change the service — not just produce a report.
