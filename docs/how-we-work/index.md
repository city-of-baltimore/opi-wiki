...
1. **CitiStat identifies the problem.** The [CitiStat program](../programs/citistat/index.md) brings agencies, OPI, and City leadership together around data, barriers, and commitments.
...
4. **[Cross-Agency Delivery](services/cross-agency-delivery.md) coordinates implementation.** It aligns decision rights, commitments, timelines, and follow-through across agencies.
...
For the full model — when to use a Stat, a data product, an Innovation Lab engagement, a Tiger Team, a Cross-Agency Delivery activation, or a decision memo — read **[How Work Moves Through OPI](how-work-moves-through-opi.md)**. For each service in its own right, see **[Services](services/index.md)**.

## Pages in this section

{{ card_grid_from("how-we-work/index.cards.yml") }}
