...
|------------------------------|------------------------------------------------|------------------------------------------------------------------------------------------|
| Director's Office | Rakeim Young, Chief of Staff                   | Operating backbone, intake, knowledge management, quality assurance, and officewide coordination. |
...
| Innovation Lab               | Dartanion Swift-Williams, interim portfolio lead | Service design, product discovery, civic technology, AI pilots, partnerships, and operational tools. |
...
|---------------------------------|------------------------------------------------------------------------------------------|
| Citywide Performance Management | Administers CitiStat, agency performance plans, KPI definitions, and follow-up routines. |
| Citywide Data and Analytics     | Strengthens data infrastructure, analytics, governance, open data, and AI readiness.     |
| Innovation Lab                  | Helps agencies design, test, and implement practical service improvements.               |
...
- Direct deposit information if you have not already submitted it.
...
- Your City email and Microsoft 365 access (Outlook, Teams, SharePoint, Planner, OneNote).

- Building access and your badge.
...
| **When**     | **What**                              | **Notes**                                                                                          |
|--------------|---------------------------------------|----------------------------------------------------------------------------------------------------|
| Morning      | Welcome and badge setup               | Pick up your badge, settle in, and complete any remaining HR paperwork.                            |
| Mid-morning  | Manager welcome meeting               | Role scope, first-week priorities, communication norms, and a tour of the team’s SharePoint site.  |
| Late morning | Laptop and account activation         | Outlook sign-in, multifactor authentication, Teams, VPN, and other required tools.                 |
| Lunch        | Onboarding buddy lunch or coffee      | Informal time with the colleague assigned to help you navigate culture and tools.                  |
...
- Sit in on at least one CitiStat session, one delivery room or product stand-up, and one team meeting in your portfolio.
...
- The Executive Director (a 30-minute overview).

- Members of your immediate team.
...
| **Tool**   | **Use it for**                                                                                             |
|------------|------------------------------------------------------------------------------------------------------------|
| SharePoint | System of record for final documents, templates, project folders, and institutional knowledge.             |
| Teams      | Day-to-day collaboration in channels. Files should live in SharePoint; Teams links are fine.               |
| OneDrive   | Drafts and personal working files. Move work products to SharePoint when they become team assets.          |
| OneNote    | Meeting notes and personal knowledge management. Use shared notebooks where teams maintain standard notes. |
| Outlook    | Formal communication and calendaring. Use clear subject tags and avoid reply-all noise.                    |
