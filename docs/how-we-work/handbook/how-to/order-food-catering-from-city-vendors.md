...
## Event is 72 hours or more away

1. Email Natasha via City email with:

   - Date and time of your event

   - Delivery location (where you want the food delivered)

   - Approximate headcount to feed

2. Natasha places the order and charges it back to OPI.

You (the requester) are listed as the contact for the food service delivery.
...
3. Email Natasha Edmonds and Desimoune McCoy with your order details (date, time,
   quantity).
