...
- Vet before accept. Owner, scope, impact, dependencies, timeline, and tradeoffs are confirmed before work begins.

- Decision-oriented. Each intake yields a decision: Accept, Decline, or Park (with a stated next step).

- Visible. Every accepted item lands in the Project Directory and on the right board.
...
- **Channel B:** Email to the OPI intake mailbox. Include the required fields in the body or as a single PDF.
...
| **Field**                 | **What we need**                                                                       |
|---------------------------|----------------------------------------------------------------------------------------|
| Requester and contact     | Name, role, agency or team, and the person we should respond to.                       |
| What is needed            | The deliverable in plain language: what does “done” look like?                         |
| Why it matters            | The decision this supports, the residents or staff affected, and the cost of inaction. |
| Due date                  | Real deadline (not aspirational) and the source of that deadline.                      |
| Decision-maker / approver | Who can say yes or no on the requester side.                                           |
...
3.  Impact. What changes for residents, staff, or decisions?

4.  Dependencies. Data access, BCIT, procurement, legal, partner readiness.

5.  Timeline. Is the requested date realistic given current commitments?

6.  Tradeoffs. What planned work would be displaced or delayed if accepted?
...
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Accept      | OPI commits. A charter is created. The project enters the Project Directory at Charter phase. The requester receives confirmation with owner, sponsor, authorizer, and next checkpoint. |
...
- Outcome statement and primary KPI(s).

- Owner, sponsor, authorizer, key partners.

- Lifecycle phase, priority, RAG, next checkpoint.
...
- **Triage:** Triage decision is communicated within 2 business days.

- **Charter:** For accepted work, charter is drafted within 5 business days.

- **Review:** Weekly Ops Review reviews “Decisions needed” and “At-risk” items.
...
- We do not begin substantive work in parallel with vetting. Vet first, commit second.

- We do not allow ad-hoc urgency to displace committed work without explicit re-prioritization.
