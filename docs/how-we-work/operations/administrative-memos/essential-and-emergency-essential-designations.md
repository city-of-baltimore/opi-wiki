...
**From:**  
Dartanion Swift-Williams, Executive Director  
Rakeim Young, Chief of Staff

**Cc:**  
Joanne Ashton, Chief of HR Shared Services  
Khalil Zaied, Deputy Mayor for Operations  
JD Merrill, Chief of Staff  
...
Essential effective Monday, March 9. These designations clarify reporting
expectations when city operations are disrupted (for example: severe weather,
public safety incidents, critical systems outages, or other emergency
activations).

This memo is intended to align with citywide emergency protocols and applicable
HR guidance. Specific pay, leave, and reporting rules remain governed by city HR
policy, bargaining unit agreements, and any event-specific direction issued by
...
- The OPI Executive Director or Chief of Staff will issue an OPI-specific
  ...
  schedule, and communications cadence.

- Emergency Essential activation is event-based. Not all events require full
  activation. Leadership will determine which teams and functions are needed.
...
1. Essential (OPI leadership and principal staff - Operations Officer V and
   above)

   - Maintain availability for incident coordination and executive decision
     support during activation windows.

   - Provide coverage plans for your areas, including delegation and escalation
     paths.

   - Ensure continuity for critical OPI responsibilities (including executive
     support, critical systems/data, cross-agency coordination, public-facing
     communications).

2. Emergency Essential (all other OPI staff)

   - Monitor city and OPI communications and be reachable during activation
     windows.

   - Be prepared to support time-sensitive operational needs (including
     analysis, communications support, data products, coordination, issue
     resolution).

   - Follow supervisor instructions on reporting location, telework posture,
     hours, and tasking.

3. Non-Essential (for reference)
...
- Microsoft Teams (OPI channels and direct supervisor communications)

- Email (as needed for formal directives)
...
- Ensure staff understand role-based expectations and activation procedures.
...
- Confirm with your supervisor how you will receive urgent activation notices
  (Teams vs phone/SMS).
...
Executive Director, Office of Performance and Innovation
