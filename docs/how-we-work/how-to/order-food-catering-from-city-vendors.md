...
- Contact Natasha via CoB email and let her know:

  - Date/time of your planned event

  - Location of your planned event (where you want the food delivered)
...
When placing your order, provide a delivery time, a contacts name, and a cell
number they can contact to meet the delivery person. **If asked, tell the
caterer that Desi or Natasha will ensure payment**

Last Step when ordering yourself: Send an email to Natasha Edmonds/Desimoune
McCoy letting them know about your order details (date, time, quantity).
