...
| Supported by all teams | Cross-Agency Delivery is staffed and operated across all of OPI. {{ role_holder("Technical Program Manager") }} (Technical Program Manager) serves as Delivery Manager. {{ role_holder("Chief of Staff") }} (Chief of Staff) provides portfolio visibility and escalation. |
...
| Activities         | Activate delivery reviews; map cross-agency workflows; track risks and dependencies; coordinate agency commitments; support executive escalation; document decisions and follow-up actions; help agencies sustain improvements through SOPs, training, and monitoring. |
...
| Delivery Manager (OPI)         | Operates Cross-Agency Delivery across activations. Currently held by the Technical Program Manager.                                    |
...
|------------------------|-------------------------|-----------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Tiger Team activation  | Authorizer + SRO        | A problem that needs Cross-Agency Delivery's coordination authority for a Tiger Team sprint (see *Relationship to the Innovation Lab* below). | Time-boxed per the Tiger Teams Playbook (typically three to six months); charter within 10 business days. |
| Standing delivery review | Authorizer + SRO        | Cross-agency commitment that needs weekly cadence for 90+ days        | Weekly cadence; commitment ledger maintained continuously.                  |
