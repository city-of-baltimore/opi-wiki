...
### How CitiStat fits: three connected jobs

CitiStat is one link in a connected chain. The Mayor's Action Plan sets the destination, Agency Performance Plans map how each agency gets there, and CitiStat is where leadership and agencies work the goals that need executive attention until they move.
...
## What CitiStat should and should not be

| CitiStat should be | CitiStat should not be |
| --- | --- |
| An executive forum focused on a limited number of priority outcomes and locations | A comprehensive review of every agency activity |
| A structured problem-solving process built on clear actions, ownership, and follow-through | A routine dashboard review or status update |
| A way to coordinate cross-agency resources and remove barriers | A replacement for agency leadership or project management |
| A place to test, evaluate, and scale what works | A permanent home for every pilot or task force |
| A source of both support and accountability for agency leaders | A forum that rewards rehearsed answers or accepts vague commitments |
...
CitiStat and agency partners weigh a candidate geography against six criteria:

| Criterion | The question |
| --- | --- |
| Severity | Is the harm or service gap large enough to warrant executive time? |
| Concentration | Is much of the problem concentrated in a clearly defined, manageable area? |
| Ability to act | Does the City have the authority, resources, and tactics to improve the condition? |
| Value of coordination | Will coordinated action beat what any single agency could do alone? |
| Equity and resident impact | Will it reduce a documented disparity or resident burden without stigmatizing the community? |
| Readiness and learning value | Can the City set a baseline, launch on time, and generate evidence to guide what comes next? |

A stable or on-track measure is acknowledged and passed over. Session time goes to a visible performance deficit, an active tactic, a barrier, or a decision that needs executive authority.

## How a Stat runs

CitiStat runs in two formats. The **monthly agency Stat** is the standing review for each principal agency named in Subtitle 61. The **biweekly place-based Stat** is a two-hour working session for operating agencies, chaired by the City Administrator, with the extra time reserved for deeper analysis and decisions, not a longer agenda. A place-based session works through:

- The priority outcome and the geographic focus
- Prior commitments, progress, and open actions
- Root-cause diagnosis using data and field intelligence
- Tactics, and where to deploy resources
- Barriers to resolve and executive decisions to make
- Commitments, owners, deadlines, and next steps

The mechanics that make a Stat repeatable are in the [Method Playbook](method-playbook.md#the-session-agendas): the time-boxed agendas, the step-by-step preparation cycle keyed to the meeting date, facilitation questions, and cabinet attendance.
...
Subtitle 61 gives CitiStat a management mandate and sets obligations for both OPI and principal agencies:
...
CitiStat only earns leadership's time if the numbers hold up. Every Stat product passes an independent quality review by the **CitiStat Program Manager** before it is presented, checking the logic, investigating outliers, confirming a coherent narrative, and making sure the data is documented and reproducible. The full quality bar is in the [Method Playbook](method-playbook.md#the-quality-bar).

## How CitiStat connects to the rest of OPI

CitiStat identifies the problem; the rest of OPI helps explain, design, deliver, and sustain the fix:

| OPI service | How it supports CitiStat |
| --- | --- |
| Citywide Performance Management | Runs the Stat method, the session cycle, KPI discipline, follow-up, and annual reporting. |
