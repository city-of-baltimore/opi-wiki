...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| Agency voice first         | Agencies begin by explaining what they tried, what changed, what did not work, and where they need help.                                          |
| No ambushes                | The major data, questions, and decisions are framed in the pre-memo. Surprises should be limited to learning, not gotchas.                        |
| Problem-solving over blame | Root-cause analysis is used to find fixes, not scapegoats. Personnel issues are handled outside the room.                                         |
| Data with context          | Data must be defined, current enough, and tied to the service question. Resident signals and field validation prevent paper performance.          |
| Intentional heat           | Facilitators apply constructive pressure when progress stalls, but the heat is directed at the problem, not the person.                           |
| No loose ends              | Every major topic ends with a decision, commitment, evidence standard, escalation, or explicit reason it is not moving.                           |
...
|------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Executive Director and Chief Data Officer, OPI | Owns CitiStat as a citywide management program; resolves major questions of scope, quality, publication posture, and operating model.                              |
...
|--------------------------------|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| Facilitator / OPI lead         | Approves scope, agenda, and pre-memo quality; confirms the right people are in the room.                    | Sets tone; keeps focus on data, decisions, and 2–3 priority deep dives; protects scope. | Recaps decisions; confirms owners and dates; oversees follow-up memo and tracker updates. |
| Executive Sponsor / Authorizer | Aligns priorities; identifies decisions or barriers likely to need executive action.                        | Clarifies expectations; applies constructive pressure; resolves or escalates blockers.  | Participates in unblock huddles; confirms escalations and delivery triggers.              |
| Agency Director / SRO          | Runs internal agency Stat; prepares agency reflection and data; confirms decision needs.                    | Presents candidly; explains what changed; commits to action and evidence.               | Executes commitments; updates tracker; verifies results and embeds changes.               |
| Data-Driven Officer            | Coordinates agency data submissions; validates definitions and sources; prepares internal follow-up status. | Supports agency response; clarifies data caveats and operational context.               | Maintains agency-side tracker; prepares updates; coordinates next data refresh.           |
...
|---------------------------|------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| T-10 business days        | Initial frame and alignment with OPI lead, analyst, agency Data-Driven Officer, and sponsor designee.      | Draft purpose, scope, prior follow-up status, data needs, and decisions likely needed.   |
| T-7 to T-5 business days  | Data build, resident signal review, map or field validation planning, and draft pre-memo/deck.             | KPI pack, data quality notes, draft analysis, priority topic framing.                    |
| T-4 business days         | Quality review with OPI lead and sponsor designee; confirm attendees and expected decisions.               | QA notes, revised agenda, final data requests.                                           |
| T-2 business days         | Final pre-memo distributed at least 48 hours before the session.                                           | Pre-meeting memo, deck, agenda, prior follow-up status, and decision questions.          |
| Session day               | Facilitated performance review with agency leadership, authorizer, OPI, and relevant partners.             | Decisions, commitments, owners, due dates, evidence standards, and escalations.          |
| T+2 business days         | Follow-up memo issued within 2 days after the session.                                                     | Commitment list, data requests, decisions made, next meeting needs, and tracker updates. |
...
| 10       | Room set-up: AV, microphones, name tags, packets ([checklist](templates.md#room-setup-and-breakdown)) | T                         |                 |
...
|-----------|--------------------------------|------------------------------------------------------------------------------------------------------------------------|
| 0–5 min   | Opening and objective          | State why the session exists, what decisions are needed, and how the discussion will run.                              |
| 5–15 min  | Prior commitments              | Review open, closed, overdue, and escalated commitments from the last session.                                         |
| 15–25 min | Agency reflection              | Agency answers: what did we try, what changed, what did not, and what do we need help deciding?                        |
| 25–40 min | KPI and resident signal review | Review core metrics, trends, maps, 311/resident signals, data quality notes, and equity/geography cuts where relevant. |
| 40–75 min | Priority deep dives            | Work through 2–3 issues using data, root-cause questions, options, and decision points.                                |
...
- What decision can be made today, and who has authority to make it?

- What action will be taken, by whom, by when, and with what evidence of completion?
...
|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| KPI definition          | Each KPI has a name, plain-language definition, formula, numerator/denominator where relevant, source system, owner, refresh cadence, and caveats. |
| Data quality notes      | Every deck names known limitations, missing data, changes in method, confidence level, and whether the data can support public reporting.          |
| Resident signals        | Include 311 trends, resident feedback, call center patterns, surveys, listening posts, or case examples when relevant.                             |
...
- A named Executive Sponsor or Authorizer.

- A defined agency owner or Senior Responsible Owner.

- Reliable-enough data to support decision-making, with caveats clearly documented.
...
|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| The problem is persistent, systemic, cross-agency, equity-relevant, or tied to a mayoral priority. | The problem is a short-term agency management issue solvable by a supervisor or agency executive team.      |
| There is a measurable service outcome or resident experience signal.                               | The main need is one-time policy analysis, legislation, or budget strategy.                                 |
...
| **Routine**                      | **Purpose**                                                                                                                   | **Typical issues**                                                                                                    |
|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| Agency Internal Stat             | Agency-led tactical management routine focused on day-to-day performance, immediate adjustments, and internal accountability. | Staff scheduling, crew performance, equipment readiness, local backlog management, basic process fixes.               |
| CitiStat                         | OPI-led or OPI-supported executive routine focused on systemic performance, leadership decisions, and sustained follow-up.    | Chronic backlogs, cross-agency handoffs, equity concerns, persistent misses, data quality issues affecting decisions. |
...
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| Internal Stat cadence                 | Run or coordinate the agency’s internal performance routine and ensure it produces tactical adjustments and emerging issues. |
| KPI readiness                         | Maintain agency KPI definitions, sources, owners, and refresh cadence in alignment with the citywide KPI dictionary.         |
| Pre-memo support                      | Coordinate timely data, narrative context, and prior follow-up status for the CitiStat pre-memo.                             |
| Follow-up management                  | Track agency commitments after CitiStat, confirm evidence of completion, and surface delays early.                           |
...
| **Publication tier**     | **Use when**                                                                                         | **Examples**                                                                                                                  |
|--------------------------|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| Full                     | The material is public, not sensitive, and useful for transparency.                                  | Plain-language Stat purpose, selected dashboards, impact briefs, annual report sections, non-sensitive data quality notes.    |
| Summary                  | The topic is public but details require filtering or simplification.                                 | Follow-up themes, high-level commitments, progress summaries, aggregate metrics, public-facing maps with appropriate caveats. |
...
The recurring artifacts produced for every Stat — the pre-memo, the deck, the follow-up memo, the commitment tracker, and the weekly radar — live with stakeholder agendas, the materials send-out standard, room setup, and the deliverable-type vocabulary on the [CitiStat Templates](templates.md) page. The QA bar each artifact must meet — code and data QC, visualization standards, pre-memo, session, and follow-up checklists — lives on the [CitiStat Quality Standards](quality-standards.md) page.
...
- [CitiStat Strategic Framework](strategic-framework.md) — the public-facing strategic frame this playbook operationalizes.
...
- [Performance Management Theory of Change](../../../about-us/our-teams/performance/performance-theory-of-change.md) — how the service is mandated, governed, staffed, measured, and sustained.
