...
| Data Governance and Analytics                  | Vera Choo                 | Applied Data Scientist                         | OPI — Data and Analytics       |
...
| KPI dictionary                | The official citywide list of metric definitions: owner, formula, source, refresh, sensitivity, and approved use. The single authoritative definition for any metric used by an intelligence product.                |
