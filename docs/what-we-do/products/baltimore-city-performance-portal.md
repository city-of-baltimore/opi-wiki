...
The portal opens on a citywide explorer of agency plans. From there you can open an agency's detail page to see its services and the measures that track them, and read quarterly and annual performance for each measure across fiscal years and reporting periods. Filters, tables, and charts stay in sync as you narrow the view, detail panels add context on a selected measure, and you can export what you are looking at to CSV.
