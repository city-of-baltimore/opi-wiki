...
When the work does not need that coordination, because the authority sits cleanly inside one agency or the cross-agency work is light, the Tiger Team is chartered through Innovation Lab intake under the agency director’s authority.
...
|---------------------|--------------------------------------------------------|
| Parking Enforcement | Department of Transportation (DOT)                     |
| Traffic Calming     | Department of Transportation (DOT)                     |
| Street Sweeping     | Department of Public Works (DPW)                       |
| Zero Waste          | Department of Public Works (DPW)                       |
| Code Enforcement    | Department of Housing and Community Development (DHCD) |
| Forestry Backlog    | Baltimore City Recreation and Parks (BCRP)             |
...
|---------------------|--------------------------------|--------------------------------------------------------------------------------|
| Authorizer          | Agency director, Deputy Mayor, or City Administrator | Authorizes the team, unblocks, and closes the work at the end. The level depends on whether Cross-Agency Delivery coordination is in play. |
...
- Bi-weekly working session with the agency partner.
...
- Scope creep. The team starts solving the system instead of one service.

- Recommendations without prototypes. The work ends with a deck, not a change.
