...
**Stat.** Short for CitiStat. A specific kind of meeting, with a performance problem, a decision-maker, reliable data, pre-read discipline, and a closure mechanism. Not every recurring data meeting is a Stat.
