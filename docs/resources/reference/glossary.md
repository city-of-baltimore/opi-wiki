...
**Frame.** The shared statement of what a given Stat is for and what it is trying to decide. The frame anchors the pre-memo, sets the priority topics, and is reviewed with stakeholders before each Stat.
