...
- Ship products with adoption in mind: documentation, data dictionaries, user guides, and clear handoff to agency owners.
...
- Experience designing and iterating dashboards, reporting views, and internal tools with a focus on usability, clarity, and decision support.
...
- Working knowledge of AI/ML evaluation, including model versioning, error analysis, and human-in-the-loop deployment patterns.
...
- Skill working with operational and program staff, asking the right questions, and developing working knowledge of how city services function.
