...
- Coordinate tiger-team operating routines (intake, kickoff, scope alignment, milestone planning, work-plan tracking, closeout).
...
- Track cross-agency dependencies and decision points; ensure timely escalation and resolution.
...
- Coordinate field operations and observation work in support of CitiStat and Innovation Lab as needed.
...
- Ability to identify problem areas and recommend appropriate solutions based on logical alternatives.
