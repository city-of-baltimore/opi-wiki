...
- Prepare clear analytical briefs for senior leadership that frame the problem, options, risks, and recommended next steps.

- Incorporate resident signals and field validation (including 311 patterns and site observations) to ground findings in service reality.
...
- Clear writing and presentation for non-technical audiences; ability to synthesize and brief succinctly.
