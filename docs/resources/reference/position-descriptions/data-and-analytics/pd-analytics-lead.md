...
- Strong skills in Python, SQL, and data visualization tools; experience building analytical workflows and reusable data assets.
...
- Ability to plan, organize, and manage analytical workstreams across cross-functional teams.
