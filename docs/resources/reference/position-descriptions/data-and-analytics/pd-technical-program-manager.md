...
|                          |                                                                                                |
|--------------------------|------------------------------------------------------------------------------------------------|
| **Working title**        | Technical Program Manager                                                                      |
...
- Coordinate user-acceptance testing, usability testing, and adoption measurement post-launch.
...
- Create templates and versioned artifacts (briefs, requirements, data dictionaries, diagrams, SOPs, runbooks, release notes) in SharePoint.
...
- Fluency with technical requirements, APIs, data management, observability, backlog hygiene, and change control.

- Understanding of metadata, lineage, testing, owner/steward models, and access workflows.
...
- Familiarity with data platforms (Azure, PostgreSQL, dbt) and with SQL and at least one programming language. Linux experience is a plus.
...
- Ability to plan, organize, and manage administrative functions across organizational units.

- Ability to compile and interpret financial and operational data, particularly for compute, storage, and security costs.
