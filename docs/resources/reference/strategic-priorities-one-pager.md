...
This goes past the app and basic communications to the work behind them: handoffs, staff training, work-order management, inspections, and real transparency. The Innovation Lab owns it, working with the 311 Center, BCIT, and the operating agencies. We watch cycle time on priority service request types, the rate of misrouted requests, and resident satisfaction with the request experience.

### Priority 2: Accelerate permit reform, starting with Accela

We streamline confusing steps and clarify who does what, working with DHCD, DPW, DOT, BCIT, and Fire to make the process transparent and easier to use. The Innovation Lab owns it with DHCD, and OPI Data and Analytics provides analytics support. We watch end-to-end permit cycle time on priority permit types, the share of applications processed without manual rework, and getting the public-facing dashboard live.
...
- Expand open data; publish the data products that anchor public dashboards.
...
- Pilot AI in narrow, high-value workflows where the data and the operating model can support it.
